"""
KARMA Explainability - The learning loop that makes this an AGENTIC RAG system.
...
PHASE 2: OUTCOME LEARNING (manual, when you know what actually happened)
  → Called later via:
    - app_essential.py "Learn" tab (enter return % in UI)
...
from karma.utils.core import evaluate_decision, extract_llm_text
...
class Explainability:
    ...
    def learn_from_outcome(
        ...
        """
        # Use shared utility for evaluation
