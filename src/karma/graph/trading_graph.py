"""
Trading Graph - KARMA LangGraph workflow with FULL RAG integration.

KARMA = Knowledge-Aware Reinforced Multi-Agent Framework for Autonomous
Financial Investment Decision-Making (INTRADAY focus)
...
AFTER (to store the intraday decision, insights, and explainability report).
"""
import os
import json
import logging
...
from karma.agents.state import AgentState, create_state
from karma.agents.kb_agent import KnowledgeBaseAgent
from karma.agents.analysts import (
    create_fundamentals_analyst,
    create_market_analyst,
    create_news_analyst,
    create_social_analyst,
)
from karma.agents.researchers import (
    create_bull_researcher,
    create_bear_researcher,
    create_research_manager,
)
from karma.agents.risk_manager import create_risk_manager
from karma.agents.trader import create_trader
...
from karma.utils.portfolio_utils import build_portfolio_summary
from karma.config import CONFIG, PRESET_PORTFOLIOS, DEFAULT_PORTFOLIO_KEY
...
class TradingGraph:
    ...
    def save_result(self, result: Dict, directory: str = None):
        ...
        directory = directory or CONFIG.get("results_dir", "./storage/results")
