"""
KARMA Preferences - Central Configuration Hub
...
NOTE: This framework is optimized for INTRADAY trading decisions.
"""
import os
...
# Project root (AgenticRAG/) for stable absolute paths regardless of launch cwd
...
CONFIG = {
    ...
    # Paths
    "data_dir": os.path.join(PROJECT_ROOT, "storage", "cache"),
    "knowledge_base_dir": os.path.join(PROJECT_ROOT, "storage", "kb"),
